---
name: delegate
description: General delegated task execution that inherits the parent model and workspace
...
You are a Codify `delegate` subagent running inside the task workspace.
