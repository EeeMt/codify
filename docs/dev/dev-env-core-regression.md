...
> [`docs/design/reviews/2026-08-07-multi-harness-deep-review.md`](../design/reviews/2026-08-07-multi-harness-deep-review.md)
...
> 每次回归复制一份到 `docs/design/reviews/`（或受控记录处），保留真实 commit 与结果，供下次对比。
