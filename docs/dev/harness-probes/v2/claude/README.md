...
python3 scripts/harness-probes/v2/replay_v2.py claude backend/tests/fixtures/harness_events/claude/success --write-to docs/dev/harness-probes/v2/claude/success.v2.jsonl
python3 scripts/harness-probes/v2/replay_v2.py codex  backend/tests/fixtures/harness_events/codex/success  --write-to docs/dev/harness-probes/v2/codex/success.v2.jsonl
```
