...
> 关联：[多 Harness 总计划决策 11](../plans/2026-08-01-multi-harness-engine-roadmap.md)、
> [Phase 2 退出门禁「凭据交付」](../plans/2026-08-01-multi-harness-phase-2-codex-integration.md)、
> [worker-harness-contract-v1.md](../architecture/worker-harness-contract-v1.md)、
> [多 Harness 设计 §11](../specs/2026-07-31-multi-harness-engine-design.md)
...
retired 凭据。详见当前 [R4.5 安全与发布审计](../evidence/2026-09-04-open-harness-v2-r4.5-security-release-audit.md)。
