...
**Related:** [Task #348 启动前延迟调查](../evidence/2026-09-02-task-348-startup-delay.md)、[Worker Profile 共享配置与运行时就绪设计](2026-08-14-worker-profile-shared-configuration-design.md)、[Worker Kits](../../dev/worker-kits.md)、[Open-Harness V2 阶段结论与剩余验收计划](../plans/2026-08-23-open-harness-v2-stage-summary-and-remaining-plan.md)
