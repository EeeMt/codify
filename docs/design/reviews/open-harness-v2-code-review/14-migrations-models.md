...
- 078 的 DELETE 未在真实数据上执行（会动到开发库的 Provider/Task 引用）；其命中行数与 `provider_id → NULL` 的影响只能引用证据文档（`docs/design/evidence/2026-09-04-open-harness-v2-r4.5-security-release-audit.md:441-451`）而非本次复现。
