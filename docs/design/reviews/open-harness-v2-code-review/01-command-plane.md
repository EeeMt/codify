...
| 契约依据 | `docs/design/architecture/open-harness-v2-schemas.md` §4/§4.1/§4.2/§4.3/§8、`docs/design/architecture/open-harness-v2.md` §6.3/§9.3、`docs/design/architecture/open-harness-v2-phase1-design.md` §2.2、`docs/design/plans/2026-08-21-open-harness-v2-implementation-plan.md` |
...
| 19 | 崩溃在 `dispatching` 状态不会永久卡住（有 lease 过期回收） | 通过 | lease 过期即可被接管（`:200-211`）→ 判为 recovery 并终态化，随后继续后续队首；Task 184 样本（`docs/design/evidence/2026-09-01-open-harness-v2-r2-candidate.md:71`）记录该链路已实测 |
