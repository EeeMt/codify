...
- Create: `docs/design/architecture/worker-harness-contract-v1.md` — Adapter 能力、请求、事件、结果和错误合同。
- Create: `docs/design/architecture/worker-canonical-event-v1.md` — Canonical Event 字段、不变量、投影与兼容策略。
...
- Create: `docs/design/architecture/worker-canonical-event-v1.md`
...
- Create: `docs/design/architecture/worker-harness-contract-v1.md`
...
- Modify: `backend/tests/unit/test_harness_event_fixtures.py`
- Modify: `docs/design/architecture/worker-harness-contract-v1.md`
- Modify: `docs/design/architecture/worker-canonical-event-v1.md`
