...
- Update `docs/dev/worker-volume-mounts.md` after runtime path changes.
...
In `docs/dev/worker-volume-mounts.md`, add a section after custom mounts:
...
```bash
git diff --check -- docs/dev/worker-volume-mounts.md docs/USER_GUIDE.zh-CN.md
```
...
```bash
git add docs/dev/worker-volume-mounts.md docs/USER_GUIDE.zh-CN.md
