...
- `docs/design/architecture/worker-canonical-event-v1.md`
- `docs/design/architecture/open-harness-v2-schemas.md`
- `docs/design/architecture/open-harness-v2.md`：若改变 Codex transport，同步当前架构说明。
...
按 [测试指南](../../dev/TESTING.md)，在 `backend/` 运行以下聚焦测试（实施时执行）：
