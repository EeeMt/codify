...
**依据：** [open-harness-v2.md](open-harness-v2.md) §6/§8.2 | [冻结 Schema](open-harness-v2-schemas.md) | [实施计划](../plans/2026-08-21-open-harness-v2-implementation-plan.md) §6
**证据：** Phase 0 OpenCode probe（`docs/dev/harness-probes/v2/opencode/`）、已验收 Phase 2 Pi 适配器（`deploy/worker-entrypoint/harness/adapters/pi*.py`、`manifest.json`、`worker_event_projector.py`）
