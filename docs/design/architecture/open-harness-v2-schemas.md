...
**依据：** [open-harness-v2.md](open-harness-v2.md) §6 | [2026-08-21-open-harness-v2-implementation-plan.md](../plans/2026-08-21-open-harness-v2-implementation-plan.md) §3.5 / §4
**证据：** [Phase 0 probe fixtures](../../dev/harness-probes/v2/README.md)（Pi `steer.raw.jsonl` / `followup.raw.jsonl` / `abort.raw.jsonl` / `success.raw.jsonl`、OpenCode `events.observed.jsonl`、Claude/Codex `success.v2.jsonl`）
